...
function addItems() {
  ...
  createItem(375, 400, 'ball');
  createItem(575, 500, 'ball');
  createItem(225, 500, 'ball');
  createItem(100, 250, 'ball');
  createItem(575, 150, 'ball');
  createItem(525, 300, 'ball');
  createItem(650, 250, 'ball');
  createItem(225, 200, 'ball');
  createItem(375, 100, 'flag');
  createItem(370, 500, 'flag');
  createItem(100, 375, 'flag');
